...
flex-wrap max-lg:flex-col">
  <div className="flex flex-col items-start">
    <a href="/">
      ...
      <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm: max-w-sm">Get shoes ready from the new term at your nearest nike store .Find your perfect size
